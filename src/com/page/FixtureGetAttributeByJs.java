...
public class FixtureGetAttributeByJs {
	private final List<List<List<String>>> getContent;

	public FixtureGetAttributeByJs(String element, String attrName) throws Exception {
		getContent = new ArrayList<List<List<String>>>();
		final String text = new PageVerification(element, attrName).getAttributeByJs();
