...
public class JsEnter extends PageApi {
	private final String enterValue;

	public JsEnter(String enterValue, String object_repository) {
	...
	public String execute() throws StopTest {
		...
		try {
			...
			executor.executeScript("arguments[0].value ='" + enterValue + "'", element);
